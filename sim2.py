...
class Sim(object):
    ...
    def Params(cls):
        ...
        # Train.
        p.Define('epochs', 20, 'Maximum training epochs.  '\
    ...
    def _SimulationDataPath(self):
        ...
        return './log/data/sim-data-d95ea2d6.pkl'.format(hash_key)
